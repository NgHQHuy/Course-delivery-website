...
import com.example.userprogress.dto.UserDto;
...
public class UserProgressService {
    ...
    public boolean isValidSection(Long sectionId) {
        String uri = "http://localhost:8081/api/section/" + sectionId;
        return checkForResponse(uri);
    }

    public boolean isValidLecture(Long lectureId) {
        String uri = "http://localhost:8081/api/lecture/" + lectureId;
        return checkForResponse(uri);
    }
