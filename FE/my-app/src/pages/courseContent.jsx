      ...
      <div className="column-display">
        ...
        >
          <video autoPlay controls controlsList="nodownload">
            <source
              src="https://ia800207.us.archive.org/15/items/BigBuckBunny_124/Content/big_buck_bunny_720p_surround.mp4#t=30"
              type="video/mp4"
            />
          </video>
        </div>
              ...
              <div className="overview-content">
                <div className="overview-content-info">
                  ...
                  <div className="last-updated">
                    <IoIosAlert size={20} />{" "}
                    <span>Last updated 24/06/2024</span>
                  </div>
                </div>
          ...
          <div className="menu-bogy">
            <div className="section">
              ...
              <div
                ...
                style={
                  sectionShow === "" ? { display: "none" } : { display: "flex" }
                }
              >
